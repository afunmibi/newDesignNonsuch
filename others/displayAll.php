...
<tr>
     ...
     <a href="vet_bills.php"><td><?php echo $row['policy_no'].'/'.$row['id'].'/'.$row['plan_type'].'/'.$row['no_of_dependant'];?></td></a>
      ...
      <a href="pa_code_approval.php?id=<?php echo $row['id'];?>"><button name="pa_code_approval" class="btn btn-primary btn-sm">Approve PA Code</button></a>
      <a href="vet_bills.php?id=<?php echo $row['policy_no'];?>"><button name="vet_bill" class="btn btn-primary btn-sm">Vet ill</button></a>
    </td>
    </tr>
  <?php
}
...
<a href="" class="m-4">Back</a>
<!-- <a href="" class="m-4">Vet BillS</a> -->
</body>
</html>