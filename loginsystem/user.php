    ...
    <div class="wrapper">
        <aside class="sidebar">
            ...
            <ul>
                ...
                <li><a href="wemabank.php"><i class="fas fa-user-plus"></i> Wema Bank</a></li>
        ...
        <main class="header">
            <div class="admin_header">
                ...
                <?php echo 'Welcome,  '. $_SESSION['info']['username']; ?>
                <img width="25px" style="border-radius: 50%;" src="../uploads/<?php echo $_SESSION['info']['photo']; ?>">
