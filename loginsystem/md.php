...
<body>
    ...
    <div class="wrapper">
        <aside class="sidebar">
            <h2>MD Panel</h2>
            <ul>
                <li><a href="../mqams/pa_code_approval.php"><i class="fas fa-check-circle"></i> Approve PA code</a></li>
                <li><a href="../mqams/vet_bills.php"><i class="fas fa-file-invoice-dollar"></i> Vet bills</a></li>
                <li><a href="../mqams/approval_bills.php"><i class="fas fa-file-invoice"></i> Approve Bills</a></li>
                <li><a href="../mqams/log_request.php"><i class="fas fa-file-alt"></i> Request PA code</a></li>
                <li><a href=""><i class="fas fa-hospital"></i> Check Hospital List</a></li>
                <li><a href="../loginsystem/displayAll.php"><i class="fas fa-users"></i> Check Enrollees</a></li>
                <li><a href="enrolment.php"><i class="fas fa-user-plus"></i> Enrolment Form</a></li>
                <li><a href="insert_staff_details.php"><i class="fas fa-user-plus"></i> Add User</a></li>
            </ul>
        </aside>
        <main class="header">
