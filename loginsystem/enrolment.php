...
$generateRandom = generateRandomInteger(); 
...
if (isset($_POST['submit_details'])) {
  ...
  $hmo_no = '051';
  $org_name ='WB';
  $policy_no = $hmo_no.'/'. $org_name.'/'.$generateRandom  ;
  ...
  if (!move_uploaded_file($file_tmp, $file_store)) {
    ...
    $stmt = $con->prepare("INSERT INTO enrolment (organization, sname, oname, policy_no, phone_no, email, e_provider, gender, plan_type, e_location, dob, no_of_dependant, reg_status, alternate_no, date_captured, photo) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        <div class="container text-center">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 mb-2">
              ...
              <input type="text" name="policy_no" class="form-control" placeholder="Policy No" readonly>
            </div>
            <div class="col-md-4 col-sm-6 mb-2">
          ...
          <div class="row">
            <div class="col-md-4 col-sm-6 mb-2">
              ...
              <select name="plan_type" class="form-control">
                ...
                <option value="PM">Platinum</option>
              </select>
            </div>
            <div class="col-md-4 col-sm-6 mb-2">
